      ...
      <div className="hidden lg:flex w-1/2 h-full relative z-10 flex-col items-center justify-center p-16">
        ...
        <div className="grid grid-cols-2 gap-6 max-w-lg">
          ...
          <div className="bg-white/5 backdrop-blur-lg border border-white/10 rounded-2xl p-6 hover:bg-white/10 transition-all duration-300 hover:scale-105 hover:shadow-2xl group">
            <div className="w-12 h-12 rounded-xl bg-linear-to-br from-slate-700 to-slate-800 flex items-center justify-center mb-4 group-hover:rotate-6 transition-transform border border-slate-600/30">
              <ClipboardList className="w-6 h-6 text-amber-200" strokeWidth={2} />
            </div>
            <h3 className="text-white font-bold text-lg mb-2">AI Extraction</h3>
            <p className="text-slate-300 text-sm">Extract invoice data automatically</p>
          </div>
          ...
          <div className="bg-white/5 backdrop-blur-lg border border-white/10 rounded-2xl p-6 hover:bg-white/10 transition-all duration-300 hover:scale-105 hover:shadow-2xl group">
            ...
            <h3 className="text-white font-bold text-lg mb-2">Smart Storage</h3>
            <p className="text-slate-300 text-sm">Organize & store all invoices</p>
          </div>

          {/* Feature 3 - Track & Monitor */}
          <div className="bg-white/5 backdrop-blur-lg border border-white/10 rounded-2xl p-6 hover:bg-white/10 transition-all duration-300 hover:scale-105 hover:shadow-2xl group">
            <div className="w-12 h-12 rounded-xl bg-linear-to-br from-slate-700 to-slate-800 flex items-center justify-center mb-4 group-hover:rotate-6 transition-transform border border-slate-600/30">
              <BarChart3 className="w-6 h-6 text-amber-200" strokeWidth={2} />
            </div>
            <h3 className="text-white font-bold text-lg mb-2">Track & Monitor</h3>
            <p className="text-slate-300 text-sm">Monitor payment status in real-time</p>
          </div>

          {/* Feature 4 - Process & Analyze */}
          <div className="bg-white/5 backdrop-blur-lg border border-white/10 rounded-2xl p-6 hover:bg-white/10 transition-all duration-300 hover:scale-105 hover:shadow-2xl group">
            <div className="w-12 h-12 rounded-xl bg-linear-to-br from-slate-700 to-slate-800 flex items-center justify-center mb-4 group-hover:rotate-6 transition-transform border border-slate-600/30">
              <FileCheck className="w-6 h-6 text-amber-200" strokeWidth={2} />
            </div>
            <h3 className="text-white font-bold text-lg mb-2">Process & Analyze</h3>
            <p className="text-slate-300 text-sm">Intelligent invoice processing</p>
          </div>
        </div>
        ...
        <div className="mt-12 text-center max-w-md">
          <p className="text-slate-200 text-xl font-semibold drop-shadow-lg leading-relaxed">
            &quot;Extract, organize, and track your invoices with AI-powered automation&quot;
          </p>
        </div>
      </div>

      {/* DIVIDER - خط فاصل خفيف */}
