  ...
  return (
    <div className='w-full flex flex-col gap-6'>
      ...
      <header className='flex flex-col items-center gap-5'>
        ...
        {/* GOOGLE BUTTON */}
        <button className='group flex justify-center items-center w-full font-medium text-slate-700 p-3 bg-white hover:bg-slate-50 gap-3 transition-all duration-300 border-2 border-slate-200 hover:border-slate-400 rounded shadow-sm hover:shadow-lg hover:scale-[1.02]'>
          <FcGoogle size={25} />
      ...
      <div className='flex items-center gap-4'>
        ...
        <span className='text-slate-400 text-xs font-semibold uppercase tracking-wider'>Or continue with email</span>
        <div className='flex-1 h-px bg-linear-to-r from-transparent via-slate-300 to-transparent'></div>
      </div>
      ...
      <main className='flex flex-col gap-5'>
        ...
        <div className='flex flex-col gap-2'>
          <div className='flex justify-between items-center'>
            <label htmlFor="password" className='font-semibold text-slate-700 text-sm'>Password</label>
            <button className='text-slate-600 hover:text-slate-900 text-sm font-semibold hover:underline decoration-2 underline-offset-2 transition-all'>
              Forgot password?
            </button>
          </div>      
          ...
          <div className='relative'>
            ...
            <button
              ...
              className='absolute right-4 top-1/2 -translate-y-1/2 text-slate-400 hover:text-slate-700 transition-all duration-300 hover:scale-110'
            >
